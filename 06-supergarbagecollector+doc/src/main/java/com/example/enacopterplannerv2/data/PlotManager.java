...
public class PlotManager extends Activity {
    ...
    private final FetchedOverlayManager polygonFetchedOverlayManager;
    ...
    public PlotManager (MapView mapView, Context ctx) {
        ...
        DataFetcher polygonDataFetcher = new DataFetcher(this);
        polygonFetchedOverlayManager = new FetchedOverlayManager(mapView, polygonDataFetcher);
        ...
        try {
            ...
            String urlAerodromes = jsonObject.getString("urlAerodromes");
            polygonDataFetcher.fetchData(urlAerodromes+"&"+ BBOX);
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (fetchOK) {
                    ...
                    //vérifié quelques instants avant la communiation réelle des données dans le programme
                    ScheduledThreadPoolExecutor exec = new ScheduledThreadPoolExecutor(1);
                    exec.schedule(() -> {
                        markerFetchedOverlayManager.plotMarkers();
                        polylineFetchedOverlayManager.plotPolylines();
                        polygonFetchedOverlayManager.plotPolygons();
